...
export class CreateCycleDto {
  @ApiProperty({ example: '2026-03-01', description: 'Date de début des règles' })
  @IsDateString()
  startDate: string;
  ...
  @ApiPropertyOptional({ description: 'Symptômes (JSON)', example: ['crampes', 'fatigue', 'maux de tête'] })
  @IsOptional()
  symptoms?: any;
