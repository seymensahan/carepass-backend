  ...
  describe('create', () => {
    it('should create an access request', async () => {
      ...
      const result = await service.create('user-d1', {
        patientCarrypassId: 'CP-2026-00001',
    ...
    it('should throw NotFoundException if doctor not found', async () => {
      ...
      await expect(
        service.create('user-d1', { patientCarrypassId: 'CP-2026-00001', reason: 'Test' }),
    ...
    it('should throw NotFoundException if patient not found', async () => {
      ...
      await expect(
        service.create('user-d1', { patientCarrypassId: 'CP-INVALID', reason: 'Test' }),
      ).rejects.toThrow(NotFoundException);
    });
